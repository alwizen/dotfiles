...
# %B sets bold text ➤
PROMPT='$B%B$PROMPTPREFIX%2~ $(custom_git_prompt)
%{$R%}%B➜%b%{$RESET%} '
RPS1="${return_code}"

ZSH_THEME_GIT_PROMPT_PREFIX="%{$M%}● "
ZSH_THEME_GIT_PROMPT_SUFFIX="%{$M%} "
...
ZSH_THEME_GIT_PROMPT_MODIFIED="%{$Y%} MODIFIED ✿"
ZSH_THEME_GIT_PROMPT_DELETED="%{$M%} DELETED ✿"
